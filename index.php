  ...
  <body>
    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
      ...
      <nav class="my-2 my-md-0 mr-md-3">        
        <a class="p-2 text-dark" href="list-personas.php">Listar</a>
    ...
    <div class="container px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      ...
      if (isset($_SESSION['message'])){
        echo '<div id="success-message" class="alert alert-success" role="alert">' . $_SESSION['message'] . '</div>';
...
<script>
  // Espera 5 segundos (5000 milisegundos) y luego esconde el mensaje de éxito
  setTimeout(function() {
